...
namespace Lucifer.DataDriven
{
    ...
    {
        [HideInInspector, SerializeReference] private IVariable[] m_Variables = new IVariable[0];
        [HideInInspector, SerializeReference] private Element[]   m_Elements  = new Element[0];
